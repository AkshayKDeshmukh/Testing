...
public class Buyingproduct {
	...
	public static void addItems(WebDriver driver) {
		...
		for (int i = 0; i < products.size(); i++) {
			...
			List<String> vegatablesNeeded = Arrays.asList(vegitables);
	...
	public static void placeOrder(WebDriver driver)
	{
		...
		String thanksStatement=driver.findElement(By.xpath("//span[contains(text(),'Thank you, your order has been placed successfully')]")).getText();
